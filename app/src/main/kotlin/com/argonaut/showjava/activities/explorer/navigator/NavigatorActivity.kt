...
import com.argonaut.showjava.activities.explorer.navigator.adapters.FilesListAdapter
import com.argonaut.showjava.activities.explorer.viewer.CodeViewerActivity
import com.argonaut.showjava.activities.explorer.viewer.ImageViewerActivity
        ...
        if (isAtRoot()) {
            ...
            setSubtitle(
                startDirectory.canonicalPath.replace(
                    "${Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)}/ShowJavaPro/sources/$packageName/",
                    ""
                )
            )
        }

...
import com.argonaut.showjava.activities.apps.AppsActivity
...
import com.argonaut.showjava.activities.landing.adapters.HistoryListAdapter
...
class LandingActivity : BaseActivity() {
    ...
    private final var TAG = "LandingActivity"
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        properties.root = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)
